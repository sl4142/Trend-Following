...
# -*- coding: utf-8 -*-
"""
Created on Wed Dec 26 17:57:22 2018
...
fname1 = "mkt_dat_dict_Output.pkl"
dir_path1 = ""
...
# 1980's data stop_level_factor = 0.5
#=========================
stop_level_factor = 0.5 #=
#=========================
...
fig, ax = plt.subplots()
ax = df_cta['PX_LAST']['1986-01':'1989-02'].plot(title="Monthly NAV vs CTA Index",legend=False, style='r-')
ax2 = ax.twinx()
...
sys1_corr = np.corrcoef(df_cta['CTA Return']['1986-01':'1989-01'].tolist(), new_mon_ret.tolist())
print("Correlation with CTA = ",sys1_corr[0,1])


#=========================== Get as of date blotter =========================== 
test_blotter = bp.get_blotter(blotter1, history, markets, df_spec, '1988-04-09')
